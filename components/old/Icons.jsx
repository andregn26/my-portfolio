export const LinkedInIcon = ({ className, fill = "currentColor", ...rest }) => (
	<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none" className={`w-full h-auto ${className}`} {...rest}>
...
export const GithubIcon = ({ className, ...rest }) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" {...rest} className={`w-full h-auto ${className}`}>
...
export const InstagramIcon = ({ className, ...rest }) => (
	<svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className={`w-full h-auto ${className}`} {...rest}>
		<g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
		<g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
		<g id="SVGRepo_iconCarrier">
			{" "}
...
export const SunIcon = ({ className, ...rest }) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...rest} className={`w-full h-auto ${className}`}>
...
export const LinkArrow = ({ className, ...rest }) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={`w-full h-auto ${className}`} {...rest}>
...
export const SassIcon = ({ className, ...rest }) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className={` ${className}`} {...rest}>
		<path
			fill="currentColor"
...
export const SanityIcon = ({ className, ...rest }) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 41" className={`${className}`} fill="currentColor" {...rest}>
...
export const CssIcon = ({ className, ...rest }) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...rest} className={`${className}`}>
		<path fill="none" d="M0 0h24v24H0z" />
		<path
			fill="currentColor"
